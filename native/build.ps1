...
if (Test-Path $envExample) {
    ...
    Write-Host "  WARNING: No .env.example at repo root - create one for credentials" -ForegroundColor DarkYellow
...
$strayExe = "$PSScriptRoot\target\release\google-ai-mcp-backend.exe"
