...
const BACKEND_NAME: &str = "google-ai-mcp-backend.exe";
const BACKEND_PORT: u16 = 11014;
const BACKEND_TAG: &str = "google-ai-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "GOOGLE_AI_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 11014",
    ...
    Ok(format!("Backend starting on port 11014"))
}
